...
public class WomenFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        ListAllProducts(WomenFragment.this.getContext(),1);

        btn_ropa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ListAllProducts(WomenFragment.this.getContext(),2);
            }
        });
        ...
        btn_zapatos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ListAllProducts(WomenFragment.this.getContext(),3);
            }
        });
        ...
        btn_accesorios.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ListAllProducts(WomenFragment.this.getContext(),4);
            }
        });
    ...
    public void ListAllProducts(Context context, int categorie)
    {
        ...
        Call<Producto> call;
        if(categorie==1) {
            call = productAPI.getWomenProducts();
        }
        else if(categorie==2)
        {
            call = productAPI.getWomenClothes();

        }
        else if(categorie==3)
        {
            call = productAPI.getWomenShoes();
        }
        else
        {
            call = productAPI.getWomenAccesories();
        }
            ...
            public void onResponse(Call<Producto> call, Response<Producto> response) {
                ...
                try {
                    if(response.isSuccessful())
                    {
                        ...
                        CustomAdapter adapter = new CustomAdapter(context, _producto.getResults());
