...
public class KidsFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        ListAllProducts(KidsFragment.this.getContext(),1);

        btn_ropa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ListAllProducts(KidsFragment.this.getContext(),2);
            }
        });
        ...
        btn_zapatos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ListAllProducts(KidsFragment.this.getContext(),3);
            }
        });
        ...
        btn_accesorios.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ListAllProducts(KidsFragment.this.getContext(),4);
            }
        });
    ...
    public void ListAllProducts(Context context, int categorie)
    {
        ...
        Call<Producto> call;
        if(categorie==1) {
            call = productAPI.getKidsProducts();
        }
        else if(categorie==2)
        {
            call = productAPI.getKidsClothes();

        }
        else if(categorie==3)
        {
            call = productAPI.getKidsShoes();
        }
        else
        {
            call = productAPI.getKidsAccesories();
        }
            ...
            public void onResponse(Call<Producto> call, Response<Producto> response) {
                ...
                try {
                    if(response.isSuccessful())
                    {
                        ...
                        CustomAdapter adapter = new CustomAdapter(KidsFragment.this.getContext(), _producto.getResults());
